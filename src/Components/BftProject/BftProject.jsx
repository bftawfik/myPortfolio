  ...
  render() {
    return (
      <div className="BftProject" onClick={this.props.resetProjectsState}>
        <div
          className={
            this.props.isActive ? "projectOverlay" : "projectOverlay hided"
          }
        >
            ...
            <div className="links">
              <div className="externalLinks">
                {this.props.data.externalLinks.liveVersion ? (
                  <a
                    href={this.props.data.externalLinks.liveVersion}
                    target="_blank"
              ...
              <div className="tags">
                {this.props.data.tags.map((tag, ndx) => (
                  <span key={ndx}>
                    <NavLink
        ...
        <div className="projectData">
          ...
          <img
            ...
            src={this.props.data.projectImgPath + "/8-line-height.jpg"}
            alt={this.props.data.projectImgPath}
          />
          <img
            className="projectImg-sm"
            src={this.props.data.projectImgPath + "/5-line-height.jpg"}
            alt={this.props.data.projectImgPath}
          />
          <div className="links">
            <div className="tags">
            ...
            <div className="externalLinks">
              {this.props.data.externalLinks.liveVersion ? (
                ...
                >
                  <span>
                    <img src="/img/icons/live.png" alt="live link icon" />
                  </span>
                </a>
              ) : null}
              {this.props.data.externalLinks.github ? (
                ...
                >
                  <span>
                    <img src="/img/icons/projectGithub.png" alt="github icon" />
                  </span>
                </a>
              ) : null}
            </div>
